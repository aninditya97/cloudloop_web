import 'package:cloudloop_mobile/core/preferences/preferences.dart';
...
void main() {
  group('core/preferences/themes/', () {
    ...
    test('Should convert from AppTheme enum to ThemeData', () {
      ...
      expect(tDark.toTheme().data.primaryColor, AppColors.primarySolidColor);
      expect(tLight.toTheme().data.primaryColor, AppColors.primarySolidColor);
    });
  });
}
